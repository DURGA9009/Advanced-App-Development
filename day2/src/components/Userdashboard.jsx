...
const UserDashboard = ({ icon: Icon, title, current, goal }) => {
    ...
    <aside className="bg-green-100 text-white w-28 space-y-9 py-7 px-2 flex flex-col items-center border-r-2 border-green-700 ">
      ...
      <nav className="flex flex-col space-y-4">
        <a href="#" className="flex flex-col items-center space-y-2 text-white hover:text-green-300 focus:text-green-300" aria-label="My Class">
          ...
          <span className="text-lg">My Class</span> {/* Increased text size */}
        </a>
        ...
        <a href="/userdata" className="flex flex-col items-center space-y-2 text-white hover:text-green-300 focus:text-green-300" aria-label="Profile">
          <FaUserAlt className="text-4xl" /> {/* Increased icon size */}
          <span className="text-lg">Profile</span> {/* Increased text size */}
        </a>
    ...
    <input type="text" placeholder="Search" className="bg-teal-100 outline-none pl-2 text-teal-600" />
      ...
      <div className="flex items-start">
        <div className="flex flex-col justify-center">
          ...
          <div className="mt-2">
            <p className="h2 max-w-[295px] md:max-w-none text-black">Hello Jane</p>
            <p className="text-md text-teal-400">Today it's great day to be fit!</p>
          </div>
        </div>
